...
namespace JogoDaForca
{
    public class Forca
    {
        ...
        public bool JogadorAcertou(char palpite)
        {
            ...
            bool jogadorVenceu = new string(letrasEncontradas) == palavraSecreta;

            if (jogadorVenceu)
                MessageBox.Show($"Você acertou a palavra {palavraSecreta}, parabéns!");

            else if (JogadorPerdeu())
                MessageBox.Show("Você perdeu! Tente novamente..., A palavra sera alterada!");
